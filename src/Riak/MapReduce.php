...
class MapReduce {
	 ...
	 * 
	 * @param string $bucket
	 *        	- Bucket name (default '_', which means all
	 *        	buckets)
	 * @param string $tag
	 *        	- Tag (default '_', which means all buckets)
	 * @param boolean $keep
	 *        	- Flag whether to keep results from this
	 ...
	 *        	- Either a named Javascript function (ie:
	 ...
	 *        	Start value to search for, or
	 *        	exact value if no end value specified.
	 * @param
	 *        	string|int optional $end End value to search for during
	 *        	a range search
	 * @return $this
	 */
